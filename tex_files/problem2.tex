...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{a)}
The observations are displayed in \figref{fig:p2_pines}, and the observation probabilities are displayed in \figref{fig:p2_alpha}. More trees are observed as $x$ and $y$ increase, but the observation probabilities also increase in the same direction. So the random field might truly be stationary.
